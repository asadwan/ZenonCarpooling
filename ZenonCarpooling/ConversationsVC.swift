...
class ConversationsVC: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    @objc func showEmailAlert() {
        ZenonUser.checkUserVerification {[weak weakSelf = self] (status) in
    ...
    @objc func pushToUserMesssages(notification: NSNotification) {
        if let user = notification.userInfo?["user"] as? ZenonUser {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        default:
            ...
            cell.clearCellData()
            cell.profilePic.image = self.items[indexPath.row].user.profileImage
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        tabBarController?.navigationItem.title = "Chat".localized()
